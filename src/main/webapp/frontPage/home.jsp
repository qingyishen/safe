	...
	<div class="pageContainer">
		 <!-- 左侧导航栏 -->
		  <div class="pageSidebar">
			...
			<a href="addtopic.jsp" target="mainFrame" class="btn"><i class="glyphicon glyphicon-edit"></i>发布留言</a><br/>
			<a href="../selectAllTopic?edituser=${username}" target="mainFrame" class="btn"><i class="glyphicon glyphicon-tags"></i>我的互动</a>
		 </div>
		 <!-- 左侧导航和正文内容的分隔线 -->
