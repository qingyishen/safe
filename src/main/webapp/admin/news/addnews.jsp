...
<html>
  ...
  <body>
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-1 main">
		<form action="${APP_PATH}/writeNews" method="post">
			<div class="table-responsive">
				<h2 class="sub-header">新增新闻</h2>
				<div class="col-md-11">
					<input type="text" class="form-control" name="title" id="title" placeholder="在此输入新闻标题">
					<textarea id="article" name="article">在此输入新闻内容...</textarea>
