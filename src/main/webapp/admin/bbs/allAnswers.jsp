  ...
  <body>
  		<div class="col-sm-9 col-sm-offset-3 col-md-11 col-md-offset-1 main">
			                        ...
			                        <td>
				                        ...
				                        <div class="btn-group">
											...
											<ul class="dropdown-menu">
												<li><a href="${APP_PATH}/updateAnswerState?id=${answers.id}">更改主题状态</a></li>
												<li><a href="${APP_PATH}/deleteAnswer?id=${answers.id }">删除主题</a></li>
											</ul>
										</div>
				                        </shiro:hasRole>
			                        </td>
				...
				<div class="col-md-6">
						...
						|有<span class="label label-default">${answerLists.total }</span>个回复.			
				</div>
				<div class="col-md-6">
